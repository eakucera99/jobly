...
const { isAdminOrCorrectUser } = require("../middleware/auth");
...
// Authorize Admin status to a user
...
router.post("/:username/jobs/:id", isAdminOrCorrectUser, async function (req, res, next) {
  try {
